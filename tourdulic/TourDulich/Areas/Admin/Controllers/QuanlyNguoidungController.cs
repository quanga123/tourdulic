    ...
    public class QuanlyNguoidungController : Controller
    {
        ...
        public JsonResult LuuSuaNguoiDung(NguoiDung model)
        {
            try
            {
                ...
                var trangThaiValues = Request.Form.GetValues("TrangThaiHoatDong");
                bool trangThaiHoatDong = trangThaiValues != null &&
                    trangThaiValues.Any(x => string.Equals(x, "true", StringComparison.OrdinalIgnoreCase));
                existing.TrangThaiHoatDong = existing.PhanQuyen == 0 || trangThaiHoatDong;
